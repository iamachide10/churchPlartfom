  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <section className="h-screen flex flex-col items-center justify-center text-center bg-black bg-opacity-70">
        ...
        <button className="mt-6 bg-yellow-400 text-black px-6 py-3 rounded-lg font-bold hover:bg-yellow-500">
          <a href="/sermons">
          Listen To Sermons
          </a>
        </button>
      ...
      <section className="py-16 px-6">
        <h2 className="text-3xl font-bold text-yellow-400 text-center mb-8">Latest Sermons</h2>
        {/* Insert SermonCard components here */}
      </section>
